...
export const Repos = ({ color, className }: PropTypes) => {
  return (
    <svg
      stroke={color}
      fill={color}
...
export const Followers = ({ color, className }: PropTypes) => {
  return (
    <svg
      stroke={color}
      fill="none"
...
export const Following = ({ color, className }: PropTypes) => {
  return (
    <svg
      stroke={color}
      fill="none"
...
export const Gists = ({ color, className }: PropTypes) => {
  return (
    <svg
      stroke={color}
      fill={color}
